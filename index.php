...
<head>
    ...
    <title>Jasa Website & Desain Grafis | dibikininweb</title>
...
<style>
        :root {
            ...
            --primary-color: #20a53a; /* modern green */
            --primary-color-2: #28c550;
            --light-gray: #6c757d;
            --dark-gray: #444;
...
.stats-section-cards {
    background-color: transparent; 
        ...
        .stat-card .icon-wrapper {
            ...
            width: 60px;
            height: 60px;
            background: linear-gradient(135deg, rgba(32,165,58,0.12), rgba(40,197,80,0.08));
            color: var(--primary-color);
            border-radius: 50%;
            font-size: 1.75rem;
    ...
    /* Penyesuaian padding body di mobile agar konten tidak tertutup navbar bawah */
        ...
        .hero-section .lead{
          ...
          .btn-primary-custom {
              ...
              height: 50px;
              width: auto;
              box-shadow: 0 8px 30px rgba(32,165,58,0.12);
            }
              .btn-primary-custom:hover{
                transform: translateY(-3px);
                box-shadow: 0 18px 40px rgba(32,165,58,0.12);
              }
          .hero-illustration {
    max-width: 80%; 
    height: auto; 
...
.btn-outline-custom:hover { color: var(--primary-color); border-color: var(--primary-color); background-color: rgba(32,165,58,0.06); }
            ...
            <div class="row g-5">
                <div class="col-lg-6">
                    <div class="cta-content">
                        ...
                        <p class="text-muted mb-4">
                            Jadilah bagian dari puluhan klien puas yang telah mempercayakan pertumbuhan digital mereka bersama dibikininweb. Kami siap menjadi partner terbaik Anda.
                        </p>
...
if (isset($_SESSION['alert'])) {
    ...
    echo "<script>
            Swal.fire({
              ...
              title: '{$alert['title']}',
              text: '{$alert['text']}',
              confirmButtonColor: '#20a53a' // Menyesuaikan warna tombol dengan tema
            });
          </script>";
